  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      when(() => mockWeatherBloc.state).thenReturn(
          () => WeatherEmpty()); // Wrap WeatherEmpty() in a function
...
testWidgets(
  ...
  (widgetTester) async {
    // arrange
    when(() => mockWeatherBloc.state).thenReturn(() => WeatherLoading()); // Wrap WeatherLoading() in a function
...
testWidgets(
  ...
  (widgetTester) async {
    // arrange
    when(() => mockWeatherBloc.state).thenReturn(() => const WeatherLoaded(testWeather)); // Wrap WeatherLoaded in a function
